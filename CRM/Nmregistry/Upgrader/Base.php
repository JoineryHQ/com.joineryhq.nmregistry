 ...
 */
class CRM_Nmregistry_Upgrader_Base {

  /**
   * @var CRM_Nmregistry_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Nmregistry_Upgrader(
        'nmregistry',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Nmregistry_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Nmregistry_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
